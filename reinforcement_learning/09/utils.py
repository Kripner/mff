...
def add_universal_arguments(parser: argparse.ArgumentParser, default_directory=None):
    ...
    parser.add_argument("--evaluate_each", type=int, default=50, help="Period of evaluation, used when training.")
    parser.add_argument("--evaluate_for", type=int, default=50, help="How many episodes to evaluate.")
