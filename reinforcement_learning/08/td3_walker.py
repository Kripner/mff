...
parser.add_argument("--parallel_envs_count", default=16, type=int, help="Number of workers to run in parallel.")
...
utils.add_universal_arguments(parser, default_directory="td3_walker")
...
class TD3Algorithm(utils.TemplateAlgorithm):
    ...
    @classmethod
    def load_from(cls, filename: str) -> "TD3Algorithm":
